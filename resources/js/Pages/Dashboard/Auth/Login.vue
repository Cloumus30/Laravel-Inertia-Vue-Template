                ...
                <div>
                    <form action="">
                        ...
                        <div class="flex">
                            ...
                            <input :type="passwordIsVisible ?'text': 'password'" id="password" class="rounded-none rounded-e-0 bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 " placeholder="elonmusk">
                        ...
                        <div class="flex justify-center mt-5">
                            <button type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Login</button>
                        </div>
                    </form>
                </div>
            </div>
